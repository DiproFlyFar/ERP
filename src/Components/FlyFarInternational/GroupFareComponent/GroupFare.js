...
const GroupFare = () => {
  return <Box sx={{ width: "85%", mt: "70px" }}>
    ...
    <Box container sx={{ boxShadow: "0px 0px 4px rgba(84, 84, 84, 0.11)", borderRadius: "12px", display: "flex", justifyContent: "space-between" }} >
     ...
     <Button sx={{marginTop:"30%",fontSize:"11px",marginLeft:"30px",color:"white",background:"#DC143C",borderRadius:"12px 0px","&:hover":{
      background:"#DC143C"
